...
export default function RootLayout({
  ...
  return (
    <html lang='en'>
      <body
        className={`${inter.className} flex flex-col md:flex-row min-h-screen mx-auto max-w-7xl overflow-y-scroll`}
      >
        <aside className='w-1/4 flex justify-end'>
          <SideNav />
        </aside>
        <main className='flex-1 border border-accent-1'>{children}</main>
